#include "model_mit.hpp"

ModelMITParams::ModelMITParams(
...
ModelMIT::ModelMIT(std::string path, ModelMITParams params) {
            this->params = params;
...
torch::Tensor ModelMIT::quat_rotate_inverse(torch::Tensor q, torch::Tensor v) {
...
torch::Tensor ModelMIT::compute_torques(torch::Tensor actions) {
...
torch::Tensor ModelMIT::compute_observation(){
...
void ModelMIT::init_observations(){
    ...
    // this->obs_history       = torch::zeros({this->params.num_observ, num_obs_history});
}

void ModelMIT::update_observations(torch::Tensor lin_vel, torch::Tensor ang_vel, torch::Tensor commands, torch::Tensor base_quat, torch::Tensor dof_pos, torch::Tensor dof_vel){
